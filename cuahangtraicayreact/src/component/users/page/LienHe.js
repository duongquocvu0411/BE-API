          ...
          <form onSubmit={xuLyGuiForm}>
            ...
            <div className="form-floating mb-3">
              <input
                ...
                required
              />
              <label htmlFor="formHoTen">
                <i className="fa fa-user me-2"></i> Họ Tên *
              </label>
            </div>
            ...
            <div className="form-floating mb-3">
              <textarea
                ...
                required
              ></textarea>
              <label htmlFor="formGhiChu">
                <i className="fa fa-comment-dots me-2"></i> Nội Dung *
              </label>
            </div>
